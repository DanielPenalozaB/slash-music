...
@Service // Marca esta clase como un servicio de Spring, lo que permite inyectarla en otros componentes
public class AlbumService {
    ...
    // Busca álbumes cuyo título contenga cierto texto (ignorando mayúsculas/minúsculas)
